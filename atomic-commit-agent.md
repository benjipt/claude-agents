...
description: Use after completing a feature or significant work. Analyzes all changes and decomposes them into multiple atomic commits following conventional commit format with square bracket scopes. Include your model name (e.g., 'Code generated by Claude Opus 4.5') in the prompt for accurate commit attribution.
